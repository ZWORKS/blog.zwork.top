...
return array(
	...
	'license_title' => 'ZYC 中文版授权协议',
	'license_content' => '感谢您选择 ZYC，它是一款国产、小巧、稳定、支持在大数据量下仍然保持高负载能力的轻型论坛。它只有 20 多个表，源代码压缩后 800k 左右，运行速度非常快，处理单次请求在 0.01 秒级别，在有 APC、XCache 的环境下可以跑到 0.00x 秒，对第三方类库依赖极少，仅仅前端依赖 jquery.js/zepto.js，作者认为它就像一辆纯手工打造的法拉利，动力强劲，没有一丝赘肉，方便部署和维护，是一个非常好的二次开发的基石。
	
ZYC 采用 Bootstrap 4.0 + JQuery 1.11 作为前端类库，全面支持移动端浏览器；后端 XiunoPHP 4.0 支持了 NoSQL 的方式操作各种数据库，这个版本是一个巨大的飞跃。
	
Xiuno 发音“修罗”，英文为 Shura，在佛教里面为六道之一"修罗道"，处于人道和天道之间。

ZYC 采用 MIT 协议发布，您可以自由修改、派生版本、商用而不用担心任何法律风险（修改后应保留原来的版权信息）。',
	'license_date' => '发布时间：2016年7月26日',
	'agree_license_to_continue' => '同意协议继续安装',
	'install_title' => 'ZYC 安装向导',
	'install_guide' => '安装向导',
